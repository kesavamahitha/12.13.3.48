...
\begin{align}
\Pr(Y=1|X=1) &= \frac{\Pr(Y=1) \cdot \Pr(X=1|Y=1)}{\Pr(Y=1) \cdot \Pr(X=1|Y=1) + \Pr(Y=2) \cdot \Pr(X=1|Y=2) + \Pr(Y=3) \cdot \Pr(X=1|Y=3)}\\
             &= \frac{ 0.5 \cdot 0.02}{0.5 \cdot 0.02 + 0.3 \cdot 0.02 + 0.2 \cdot 0.03}\\
             &= \frac{5}{11}\\
\end{align}
\end{document}
